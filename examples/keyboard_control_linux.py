"""Lite3机器人键盘控制示例（Linux/Mac专用版本）

此版本仅适用于Linux/Mac系统，使用 tty 和 termios 模块
Windows用户请使用 keyboard_control.py（跨平台版本）
"""
import time
import sys
import threading
...
class KeyboardController:
    ...
    def print_menu(self):
        """打印控制菜单"""
        print("\n" + "=" * 60)
        print("Lite3机器人键盘控制（Linux/Mac专用）")
        print("=" * 60)
        print("\n【基本控制】")
        print("  空格键  - 起立/趴下切换")
        print("  e       - 软急停")
    ...
    def run(self):
        ...
        print("使用 tty/termios 模块监听键盘（阻塞式读取）")
        print("开始监听键盘输入...\n")
...
def main():
    ...
    if platform.system() == 'Windows':
        print("\n❌ 错误: 此脚本仅适用于 Linux/Mac 系统")
        print("Windows 用户请使用: python keyboard_control.py")
        print("\n")
        return
    ...
    print("3. 运行此脚本: python keyboard_control_linux.py")
    print("4. 使用键盘控制机器人")
    print("\n注意:")
    print("- 使用 tty/termios 模块（Linux/Mac专用）")
    print("- 按键后动作会立即执行")
    print("- 按s可以查看当前状态")
    print("- 按q或ESC退出程序")
    print("\n")
